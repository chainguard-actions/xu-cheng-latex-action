...
* `texlive_version`
    ...
    The version of TeXLive to be used. Supported inputs include 2020, 2021, 2022, 2023, 2024, 2025, and latest. By default the latest TeXLive is used. This input cannot co-exist with `docker_image` input. An example to use this input:
    ```yaml
    - uses: xu-cheng/latex-action@v3
      with:
        root_file: main.tex
